export class ServiceAccount {
  static getFirebabaseConfig(): any {
    return {
      ...
      private_key: process.env.NOHAI_FIREBASE_PRIVATE_KEY as string,
      ...
      client_x509_cert_url:
        'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-xzfb6%40nohai-pushnotification.iam.gserviceaccount.com',
    };
  }
}
