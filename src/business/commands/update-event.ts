import { Observable, from, zip, of, iif } from 'rxjs';
...
export class UpdateEvent implements IUpdateEvent {
    ...
    private sendNotifications(event: UpdateEventInput): Observable<boolean> {
    ...
    private sendEmails(event: UpdateEventInput): Observable<boolean> {
